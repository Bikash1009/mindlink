...
<body>
    ...
    if(isset($_SESSION["user"])){
        if(($_SESSION["user"])=="" or $_SESSION['usertype']!='m'){ // Changed 'a' to 'm' for moderator
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-patient menu-active menu-icon-patient-active">
                        <a href="patient.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Patients List</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row">
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <table width="93%" height="25%" class="sub-table scrolldown" style="border-spacing:0;">
                        <thead>
                        <tr>
